...
test_data_dir = "D:/Research/Cholec80/images"
PATH = "./runs/cholec80_train_2ToolB_a_0_3_filter3_v1_2_last.pth"
    ...
    with tqdm(total=dataset_length) as epoch_pbar:
        ...
        with torch.no_grad():
            for batch, (image, target, frame_num, path) in enumerate(dataloader):
                ...
                with open("cholec80_train_2ToolB_a_0_3_filter3_v1_2_last.txt", "a") as f:
